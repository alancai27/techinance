  ...
  scenes: {
    ...
    "u2a2-start": {
      ...
      text: [
        ...
        '"An active digital footprint is all the information you deliberately share online—like social media posts, online shopping, banking forms, and app downloads. You know this data is left behind, even though it is nearly impossible to fully delete."',
      ...
      options: [
        {
          ...
          correct: false,
          feedback:
            "Incorrect. A social media post is deliberately created and published by the user, making it an active digital footprint.",
        },
        {
        ...
        },
        {
          ...
          correct: false,
          feedback:
            "Incorrect. Writing a comment on TikTok is an intentional user action, which forms an active digital footprint.",
        },
        {
          label: "Download of an app",
          correct: false,
          feedback:
            "Incorrect. Initiating an app download is an intentional action, contributing to an active digital footprint.",
        },
      ],
      ...
      options: [
        {
          ...
          correct: false,
          feedback:
            "Incorrect. Web cookies are technical data files, not edible snacks.",
        },
        {
          label: "Pop-ups and adds.",
          correct: false,
          feedback:
            "Incorrect. Advertisements and pop-up windows are visual web elements, not cookie files.",
        },
        {
          label: "Viruses that are downloaded on your computer.",
          correct: false,
          feedback:
            "Incorrect. Cookies are not viruses or malware; they are data text files, although insecure cookies can pose privacy risks.",
        },
        {
      ...
      options: [
        {
          ...
          correct: false,
          feedback:
            "Incorrect. A MAC address is a physical hardware address for local network interfaces, not the primary Internet IP address.",
        },
        {
          label: "IP Address",
          correct: true,
        ...
        },
        {
          ...
          correct: false,
          feedback:
            "Incorrect. An email address identifies a mailbox, not a computer's network interface.",
        },
        {
          label: "Electronic Address",
          correct: false,
          feedback: "Incorrect. Electronic address is a generic, non-standard term.",
        },
      ],
      source: SOURCES.cookieStats,
      xp: 25,
    ...
    "u2a2-dossier": {
      ...
      terms: [
        ...
        },
        {
          ...
          definition:
            "Technical hardware and software data about the device you are using.",
        },
        {
